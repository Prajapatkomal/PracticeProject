...
export const Navbar = () => {
  ...
  return (
    <>
      ...
      sticky? "sticky-navbar shadow-md bg-slate-400  dark:bg-slate-900 text-white transition-all duration-300 ease-in-out" :""}`}>
        <div className="navbar">
          ...
          <div className="navbar-end space-x-3">
            ...
            <label className="swap swap-rotate">
              ...
              {/* moon icon */}
              <svg
                className="swap-on h-7 w-7 fill-current mx-2"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
